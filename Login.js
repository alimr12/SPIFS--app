...
const Login = ({ onLoginSuccess, onSignup }) => {
  ...
  // Dummy correct credentials (for frontend-only testing)
  // email: test@test.com
  // password: 123
  ...
  // ⚠️ Backend failed → fallback to dummy login
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        ...
        <p style={styles.subtitle}>Sign in to your SPIFS account</p>
...
const styles = {
  page: {
    ...
    minHeight: "100vh",
    maxHeight: "100vh", // ✅ Scroll enabled but layout stable
    overflowY: "scroll", // ✅ Scroll fix applied
    background:
      "linear-gradient(135deg, #0F172A 0%, #1E293B 30%, #312E81 60%, #1E40AF 100%)",
    display: "flex",
    justifyContent: "center",
    alignItems: "flex-start", // ✅ Allows scroll from top
    color: "white",
    position: "relative",
    padding: "2rem 0",
  },
